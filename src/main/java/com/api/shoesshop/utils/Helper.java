...
public class Helper {
    ...
    public static String generateLikeQuery(String prefix, String key, String value) {
        return value == null ? "" : (" " + prefix + " " + key + " like '%" + value + "%'");
    }

    public static String generateEqualNumberQuery(String prefix, String key, String value) {
        return value == null ? "" : (" " + prefix + " " + key + "=" + value);
    }
    ...
    public static Pageable getPageable(Map<String, String> query) {
        ...
        return PageRequest.of(page == null ? 0 : Integer.parseInt(page),
